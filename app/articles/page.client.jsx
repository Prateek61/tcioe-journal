            ...
            <ArticleLists key={verify.id}>
              <IndividualCard>
                ...
                {verify.authors.length > 2 && (
                  <span>
                    {`${authorMap[verify.authors[0].id]} .... ${authorMap[verify.authors[verify.authors.length - 1].id]
                      }`}
                  </span>
                )}
                ...
                {verify.authors.length == 2 && (
                  <span>
                    {`${authorMap[verify.authors[0].id]}, ${authorMap[verify.authors[1].id]
                      }`}
                  </span>
                )}
